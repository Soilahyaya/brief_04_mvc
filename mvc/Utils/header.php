		...
		<ul class="nav justify-content-center nav-pills" id="menu">
			...
			<li class="nav-item dropdown">
        		...
        		<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          			<a class="dropdown-item" href="?controller=livre&action=ajouter_un_livre">Ajouté un livres</a>
      		...
      		<li class="nav-item dropdown">
        		...
        		<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					<a class="dropdown-item" href="?controller=fournisseur&action=ajouter_un_fournisseur">Ajouté un fournisseurs</a>
          			<a class="dropdown-item" href="?controller=fournisseur&action=all_fournisseur">Tous les fournisseurs</a>
                <a class="dropdown-item" href="?controller=fournisseur&action=all_raison_sociale">Par raison sociale</a>
			...
			<li><?php echo '<a href="deconnexion.php"><button>Deconnexion</button></a>';?>
</li>
		</ul>
	</div>
</header>